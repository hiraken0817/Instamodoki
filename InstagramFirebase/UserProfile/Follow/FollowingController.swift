...
class FollowingController:UICollectionViewController,UICollectionViewDelegateFlowLayout,FollowFollowerCellDelegate{
    
    static let updateFeedNotificationName = NSNotification.Name(rawValue: "UpdateFollowing")
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "フォロー中"
    ...
    fileprivate func fetchUsers(){
        ...
        Firestore.firestore().collection("following").document(userId).collection("followingUser").getDocuments{ [weak self] (snapshot, err) in//
