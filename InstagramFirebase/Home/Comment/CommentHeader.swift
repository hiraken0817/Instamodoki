...
class CommentHeader: UICollectionViewCell {
    ...
    var captionComment:Comment?{
        didSet{
            guard let comment = captionComment else { return }
    ...
    override init(frame: CGRect) {
        ...
        let separeteLine = UIView()
        separeteLine.backgroundColor = .systemGray
        addSubview(separeteLine)
        separeteLine.anchor(top: nil, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 0, paddingLeft: 8, paddingBottom: 0, paddingRight: 8, width: 0, height: 0.5)
    }
